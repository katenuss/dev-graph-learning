...
jsPsych.plugins["mars-trial"] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html += '</div><div id="timer" style="height:100px;"></div>';
    ...
    jsPsych.pluginAPI.setTimeout(function(){
        document.getElementById('timer').innerHTML = "<img src='img/mars/timer5.png' height='100' width='100'></img>";
      ...
      jsPsych.pluginAPI.setTimeout(function(){
        document.getElementById('timer').innerHTML = "<img src='img/mars/timer4.png' height='100' width='100'></img>";
          // add event listeners to buttons
      for (var i = 0; i < trial.choices.length; i++) {
        display_element.querySelector('#jspsych-mars-trial-button-' + i).addEventListener('click', function(e){
          var choice = e.currentTarget.getAttribute('data-choice'); // don't use dataset for jsdom compatibility
      ...
      jsPsych.pluginAPI.setTimeout(function(){
        document.getElementById('timer').innerHTML = "<img src='img/mars/timer3.png' height='100' width='100'></img>";
          // add event listeners to buttons
      for (var i = 0; i < trial.choices.length; i++) {
        display_element.querySelector('#jspsych-mars-trial-button-' + i).addEventListener('click', function(e){
          var choice = e.currentTarget.getAttribute('data-choice'); // don't use dataset for jsdom compatibility
      ...
      jsPsych.pluginAPI.setTimeout(function(){
        document.getElementById('timer').innerHTML = "<img src='img/mars/timer2.png' height='100' width='100'></img>";
          // add event listeners to buttons
      for (var i = 0; i < trial.choices.length; i++) {
        display_element.querySelector('#jspsych-mars-trial-button-' + i).addEventListener('click', function(e){
          var choice = e.currentTarget.getAttribute('data-choice'); // don't use dataset for jsdom compatibility
      ...
      jsPsych.pluginAPI.setTimeout(function(){
        document.getElementById('timer').innerHTML = "<img src='img/mars/timer1.png' height='100' width='100'></img>";
          // add event listeners to buttons
      for (var i = 0; i < trial.choices.length; i++) {
        display_element.querySelector('#jspsych-mars-trial-button-' + i).addEventListener('click', function(e){
          var choice = e.currentTarget.getAttribute('data-choice'); // don't use dataset for jsdom compatibility
    ...
    function after_response(choice) {
      ...
      if(display_feedback){
        if(response.unshuffled_button == 0){
          html += "<div id='timer'> <img src='img/mars/blanktimer.png' height='100' width='100'></img> </div>"
          html += trial.pos_img;
        }
